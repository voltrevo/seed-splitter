...
export default async function splitExisting() {
  ...
  console.log([
    ...
    "shares. A share is a point on your polynomial, and the name of the share",
    "encodes its X coordinate. Names are required for recovery.",
    "",
  ...
  console.log([
    ...
    "this software to do the recovery, so you may want to store this software",
    "alongside each share.",
    "",
    "It's also a good idea to give this polynomial a name and include that",
    "name with each share. If you have multiple of these, you'll need to know",
    "which polynomial each share belongs to.",
  ].join("\n"));
}
